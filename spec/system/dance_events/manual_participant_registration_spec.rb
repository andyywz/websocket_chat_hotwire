...
describe "Manually adding participants to dance events" do
  ...
  describe "registration access" do
    ...
    it "Random users cannot access the dance event registration page" do
      ...
      expect(page).not_to have_link("Add participants")
    end
    ...
    it "Random users cannot view unregister participant buttons" do
      ...
      within("#user_#{test_users.last.id}") do
        expect(page).not_to have_button("Unregister")
      end
    end
