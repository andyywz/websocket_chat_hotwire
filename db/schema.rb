...
ActiveRecord::Schema[7.1].define(version: 2024_04_02_012214) do
  ...
  create_table "dance_event_participants", force: :cascade do |t|
    ...
    t.index ["status"], name: "index_dance_event_participants_on_status"
  ...
  create_table "dance_events", force: :cascade do |t|
    ...
    t.index ["published"], name: "index_dance_events_on_published"
